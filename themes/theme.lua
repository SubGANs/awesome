...
theme.wallpaper = os.getenv("HOME").."/.config/awesome/themes/wallpapers/wallpaper-arch.png"
...
theme.bg_normal  = theme.colors.panel1
theme.bg_focus   = theme.colors.base1
theme.bg_urgent  = theme.colors.red
theme.bg_systray = theme.colors.base3


theme.taglist_fg_focus = "#15a336"
-- }}}
...
-- {{{
icon_path = os.getenv("HOME").."/.config/awesome/themes/icons/icon-scalable/"
theme.icon_firefox = icon_path.."firefox.svg"
theme.icon_filemanager = icon_path.."file-manager-blue.svg"
theme.icon_terminal = icon_path.."terminal.svg"
theme.icon_subl = icon_path.."sublime-text.svg"
theme.icon_chromium = icon_path.."chromium.svg"
